CC = gcc
OBJFILES = add_balloon.o add_text.o build_gui.o build_box_annotation.o build_box_theme.o build_box_configuration.o logging.o main.o process_image.o read_annotation.o read_configuration.o read_themes.o resize.o initialize_gui.o memory_management.o cleanup.o build_controllers_annotation.o build_controllers_window.o build_controllers_theme.o read_files.o read_annotation.o read_themes.o read_configuration.o
...
read_files.o: read_save/read_files.c headers.h
	$(CC) $(CFLAGS) -c $^
